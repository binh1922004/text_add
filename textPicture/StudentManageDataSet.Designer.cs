...
namespace textPicture {
    ...
    public partial class StudentManageDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDetailDataTable : global::System.Data.TypedTableBase<StudentDetailRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentDetailRow AddStudentDetailRow(string ID, string FirstName, string LastName, System.DateTime BirthDate, string Gender, string Phone, string Address, byte[] Image) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentDetailRow FindByID(string ID) {
        ...
        public partial class StudentDetailRow : global::System.Data.DataRow {
            ...
            public string ID {
                get {
                    return ((string)(this[this.tableStudentDetail.IDColumn]));
                }
                set {
            ...
            public byte[] Image {
                get {
                    try {
                        return ((byte[])(this[this.tableStudentDetail.ImageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Image\' in table \'StudentDetail\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableStudentDetail.ImageColumn] = value;
                }
            }
            ...
            public bool IsImageNull() {
                return this.IsNull(this.tableStudentDetail.ImageColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetImageNull() {
                this[this.tableStudentDetail.ImageColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace textPicture.StudentManageDataSetTableAdapters {
    ...
    public partial class StudentDetailTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[StudentDetail] ([ID], [FirstName], [LastName], [BirthDate], [Gender], [Phone], [Address], [Image]) VALUES (@ID, @FirstName, @LastName, @BirthDate, @Gender, @Phone, @Address, @Image);
SELECT ID, FirstName, LastName, BirthDate, Gender, Phone, Address, Image FROM StudentDetail WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[StudentDetail] SET [ID] = @ID, [FirstName] = @FirstName, [LastName] = @LastName, [BirthDate] = @BirthDate, [Gender] = @Gender, [Phone] = @Phone, [Address] = @Address, [Image] = @Image WHERE (([ID] = @Original_ID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_BirthDate = 1 AND [BirthDate] IS NULL) OR ([BirthDate] = @Original_BirthDate)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT ID, FirstName, LastName, BirthDate, Gender, Phone, Address, Image FROM StudentDetail WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::textPicture.Properties.Settings.Default.StudentManageConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, BirthDate, Gender, Phone, Address, Image FROM dbo" +
                ".StudentDetail";
        ...
        public virtual int Fill(StudentManageDataSet.StudentDetailDataTable dataTable) {
        ...
        public virtual StudentManageDataSet.StudentDetailDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentManageDataSet.StudentDetailDataTable dataTable = new StudentManageDataSet.StudentDetailDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentManageDataSet.StudentDetailDataTable dataTable) {
        ...
        public virtual int Delete(string Original_ID, string Original_FirstName, string Original_LastName, global::System.Nullable<global::System.DateTime> Original_BirthDate, string Original_Gender, string Original_Phone) {
            if ((Original_ID == null)) {
        ...
        public virtual int Insert(string ID, string FirstName, string LastName, global::System.Nullable<global::System.DateTime> BirthDate, string Gender, string Phone, string Address, byte[] Image) {
            if ((ID == null)) {
        ...
        public virtual int Update(string ID, string FirstName, string LastName, global::System.Nullable<global::System.DateTime> BirthDate, string Gender, string Phone, string Address, byte[] Image, string Original_ID, string Original_FirstName, string Original_LastName, global::System.Nullable<global::System.DateTime> Original_BirthDate, string Original_Gender, string Original_Phone) {
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, global::System.Nullable<global::System.DateTime> BirthDate, string Gender, string Phone, string Address, byte[] Image, string Original_ID, string Original_FirstName, string Original_LastName, global::System.Nullable<global::System.DateTime> Original_BirthDate, string Original_Gender, string Original_Phone) {
            return this.Update(Original_ID, FirstName, LastName, BirthDate, Gender, Phone, Address, Image, Original_ID, Original_FirstName, Original_LastName, Original_BirthDate, Original_Gender, Original_Phone);
        }
    }
